  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="pbot" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "pbot - Modern project management" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "pbot - Modern project management" },
];
