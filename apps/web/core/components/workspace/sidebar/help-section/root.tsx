  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open("https://github.com/Liewzheng/planebot", "_blank")}>
        ...
        <CustomMenu.MenuItem
          onClick={() => window.open("https://github.com/Liewzheng/planebot", "_blank", "noopener,noreferrer")}
        >
          <div className="flex items-center gap-x-2 rounded-sm text-11">
