...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      action: () => {
        window.open("https://github.com/Liewzheng/planebot", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    ...
    },
    {
      ...
      icon: Github,
      action: () => {
        window.open("https://github.com/Liewzheng/planebot/issues/new/choose", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
