...
const PROJECT_ROLE_OPTIONS: IRoleOption[] = [
  { value: String(EUserProjectRoles.ADMIN), labelKey: "role_admin" },
  { value: String(EUserProjectRoles.MEMBER), labelKey: "role_member" },
  { value: String(EUserProjectRoles.GUEST), labelKey: "role_guest" },
];

const WORKSPACE_ROLE_OPTIONS: IRoleOption[] = [
  { value: String(EUserWorkspaceRoles.ADMIN), labelKey: "role_admin" },
  { value: String(EUserWorkspaceRoles.MEMBER), labelKey: "role_member" },
  { value: String(EUserWorkspaceRoles.GUEST), labelKey: "role_guest" },
