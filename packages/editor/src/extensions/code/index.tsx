...
type CodeBlockExtensionProps = {
  fileHandler: TFileHandler;
};

export const CustomCodeBlockExtension = ({ fileHandler }: CodeBlockExtensionProps) =>
  CodeBlockLowlight.extend({
    addOptions() {
      return {
        ...this.parent?.(),
        uploadMermaidDiagram: fileHandler.uploadMermaidDiagram,
